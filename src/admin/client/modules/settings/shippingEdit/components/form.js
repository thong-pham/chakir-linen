              ...
              <div className="col-xs-12 col-sm-8">
                ...
                <div className="row">
                  <div className="col-xs-6">
                    <Field component={TextField} name="carrierCode" fullWidth={true} floatingLabelText={messages.carrierCode}/>
                  </div>
                  <div className="col-xs-6">
                    <Field component={TextField} name="serviceCode" fullWidth={true} floatingLabelText={messages.serviceCode}/>
                    <Divider />
                  </div>
                </div>
