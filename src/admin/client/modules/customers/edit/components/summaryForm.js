  ...
  render() {
    ...
    return (
        <form onSubmit={handleSubmit} style={{
          ...
          <div>
            <div>
              <Field component={TextField} fullWidth={true} name="firstName" floatingLabelText={messages.firstName}/>
            </div>
            <div>
              <Field component={TextField} fullWidth={true} name="lastName" floatingLabelText={messages.lastName}/>
            </div>
