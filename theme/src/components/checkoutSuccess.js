    ...
    return (
      <div className="checkout-success-details">
        ...
        <h1 className="checkout-success-title">
          <img src="/assets/images/success.svg" alt=""/><br />
        ...
        <div className="columns">
          <div className="column is-offset-7 checkout-success-totals">
            ...
            <div><span>Tax:</span><span>{helper.formatCurrency(order.tax_included_total, settings)}</span></div>
            <div><b>Order Total:</b><b>{helper.formatCurrency(order.order_total, settings)}</b></div>
          </div>
        </div>
